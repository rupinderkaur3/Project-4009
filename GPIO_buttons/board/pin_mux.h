...
/*! @name PIO1_0 (number 14), J2[3]/P1_0-PDM0_DATA-CT32B3_MAT1
  @{ */
#define BOARD_SPEED1_GPIO GPIO /*!<@brief GPIO device name: GPIO */
#define BOARD_SPEED1_PORT 1U   /*!<@brief PORT device name: 1U */
#define BOARD_SPEED1_PIN 0U    /*!<@brief 1U pin index: 0 */
                               /* @} */

/*! @name PIO1_14 (number 57), J2[1]/P1_14-SCTO7
  @{ */
#define BOARD_DIRECTION1_GPIO GPIO /*!<@brief GPIO device name: GPIO */
#define BOARD_DIRECTION1_PORT 1U   /*!<@brief PORT device name: 1U */
#define BOARD_DIRECTION1_PIN 14U   /*!<@brief 1U pin index: 14 */
                                   /* @} */

/*! @name PIO1_13 (number 54), J2[7]/P1_13-CT32B1_MAT1
  @{ */
#define BOARD_SPEED2_GPIO GPIO /*!<@brief GPIO device name: GPIO */
#define BOARD_SPEED2_PORT 1U   /*!<@brief PORT device name: 1U */
#define BOARD_SPEED2_PIN 13U   /*!<@brief 1U pin index: 13 */
                               /* @} */

/*! @name PIO1_12 (number 51), J2[9]/P1_12-CT32B1_MAT0-ACCl_INT1
  @{ */
#define BOARD_DIRECTION2_GPIO GPIO /*!<@brief GPIO device name: GPIO */
#define BOARD_DIRECTION2_PORT 1U   /*!<@brief PORT device name: 1U */
#define BOARD_DIRECTION2_PIN 12U   /*!<@brief 1U pin index: 12 */
                                   /* @} */
