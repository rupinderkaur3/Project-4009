...
- {pin_num: '13', pin_signal: PIO0_31/PDM0_CLK/FC2_CTS_SDA_SSEL0/CTIMER2_CAP2/CTIMER0_CAP3/CTIMER0_MAT3/ADC0_2, label: 'J2[17]/J3[2]/P1[7]/U3[4]/SW2/P0_31-PDM0_CLK-ISP0_EN',
  identifier: SW2}
- {pin_num: '14', pin_signal: PIO1_0/PDM0_DATA/FC2_RTS_SCL_SSEL1/CTIMER3_MAT1/CTIMER0_CAP0/ADC0_3, label: 'J2[3]/P1_0-PDM0_DATA-CT32B3_MAT1', identifier: SPEED1}
...
- {pin_num: '51', pin_signal: PIO1_12/FC5_RXD_SDA_MOSI/CTIMER1_MAT0/FC7_SCK/UTICK_CAP2, label: 'J2[9]/P1_12-CT32B1_MAT0-ACCl_INT1', identifier: DIRECTION2}
...
- {pin_num: '54', pin_signal: PIO1_13/FC5_TXD_SCL_MISO/CTIMER1_MAT1/FC7_RXD_SDA_MOSI_DATA, label: 'J2[7]/P1_13-CT32B1_MAT1', identifier: SPEED2}
- {pin_num: '57', pin_signal: PIO1_14/FC2_RXD_SDA_MOSI/SCT0_OUT7/FC7_TXD_SCL_MISO_WS, label: 'J2[1]/P1_14-SCTO7', identifier: DIRECTION1}
...
void BOARD_InitPins_cm4(void)
{
    ...
    GPIO_PinInit(BOARD_SPEED1_GPIO, BOARD_SPEED1_PORT, BOARD_SPEED1_PIN, &SPEED1_config);
    ...
    GPIO_PinInit(BOARD_DIRECTION2_GPIO, BOARD_DIRECTION2_PORT, BOARD_DIRECTION2_PIN, &DIRECTION2_config);
    ...
    GPIO_PinInit(BOARD_SPEED2_GPIO, BOARD_SPEED2_PORT, BOARD_SPEED2_PIN, &SPEED2_config);
    ...
    GPIO_PinInit(BOARD_DIRECTION1_GPIO, BOARD_DIRECTION1_PORT, BOARD_DIRECTION1_PIN, &DIRECTION1_config);
