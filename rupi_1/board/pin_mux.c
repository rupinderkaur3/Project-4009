...
- {pin_num: '62', pin_signal: PIO1_15/PDM0_CLK/SCT0_OUT5/CTIMER1_CAP3/FC7_CTS_SDA_SSEL0, label: 'J1[17]/P1_15-SCTO5-FC7_CTS', identifier: RIGHT_MOTOR_DIRECTION1;RIGHT_MOTOR_DIRECTION2}
...
- pin_list:
  ...
  - {pin_num: '62', peripheral: SCT0, signal: 'OUT, 5', pin_signal: PIO1_15/PDM0_CLK/SCT0_OUT5/CTIMER1_CAP3/FC7_CTS_SDA_SSEL0, identifier: RIGHT_MOTOR_DIRECTION2}
...
void BOARD_InitPins_cm4(void)
{
    ...
    GPIO_PinInit(BOARD_LEFT_MOTOR_SPEED_GPIO, BOARD_LEFT_MOTOR_SPEED_PORT, BOARD_LEFT_MOTOR_SPEED_PIN, &LEFT_MOTOR_SPEED_config);
    ...
    GPIO_PinInit(BOARD_LEFT_MOTOR_DIRECTION_GPIO, BOARD_LEFT_MOTOR_DIRECTION_PORT, BOARD_LEFT_MOTOR_DIRECTION_PIN, &LEFT_MOTOR_DIRECTION_config);
    ...
    GPIO_PinInit(BOARD_RIGHT_MOTOR_SPEED_GPIO, BOARD_RIGHT_MOTOR_SPEED_PORT, BOARD_RIGHT_MOTOR_SPEED_PIN, &RIGHT_MOTOR_SPEED_config);
    ...
    GPIO_PinInit(BOARD_RIGHT_MOTOR_DIRECTION_GPIO, BOARD_RIGHT_MOTOR_DIRECTION_PORT, BOARD_RIGHT_MOTOR_DIRECTION_PIN, &RIGHT_MOTOR_DIRECTION_config);
...
void BOARD_InitLink2MCUPins(void)
{
    ...
    IOCON->PIO[0][23] = ((IOCON->PIO[0][23] &
                         ...
                         /* Selects pin function.
                          * : PORT023 (pin 1) is configured as FC1_RTS_SCL_SSEL1. */
                         | IOCON_PIO_FUNC(PIO023_FUNC_ALT1)

                         /* Controls slew rate of I2C pad.
                          * : I2C mode. */
                         | IOCON_PIO_I2CSLEW(PIO023_I2CSLEW_I2C_MODE)
    ...
    IOCON->PIO[0][24] = ((IOCON->PIO[0][24] &
                         ...
                         /* Selects pin function.
                          * : PORT024 (pin 2) is configured as FC1_CTS_SDA_SSEL0. */
                         | IOCON_PIO_FUNC(PIO024_FUNC_ALT1)

                         /* Controls slew rate of I2C pad.
                          * : I2C mode. */
                         | IOCON_PIO_I2CSLEW(PIO024_I2CSLEW_I2C_MODE)
...
- pin_list:
  ...
  - {pin_num: '30', peripheral: GPIO, signal: 'PIO1, 10', pin_signal: PIO1_10/FC6_TXD_SCL_MISO_WS/SCT0_OUT4/FC1_SCK/USB0_FRAME, direction: OUTPUT, gpio_init_state: 'true'}
  - {pin_num: '11', peripheral: GPIO, signal: 'PIO0, 29', pin_signal: PIO0_29/FC1_RXD_SDA_MOSI/SCT0_OUT2/CTIMER0_MAT3/CTIMER0_CAP1/CTIMER0_MAT1/ADC0_0, identifier: LED_RED,
 ...
 * END ****************************************************************************************************************/
/* Function assigned for the Cortex-M4F */
void BOARD_InitSecureMCUPins(void)
{
    /* Enables the clock for the IOCON block. 0 = Disable; 1 = Enable.: 0x01u */
    CLOCK_EnableClock(kCLOCK_Iocon);
    ...
    IOCON->PIO[0][25] = ((IOCON->PIO[0][25] &
                         ...
                         /* Selects pin function.
                          * : PORT025 (pin 3) is configured as FC4_RTS_SCL_SSEL1. */
                         | IOCON_PIO_FUNC(PIO025_FUNC_ALT1)

                         /* Controls slew rate of I2C pad.
                          * : I2C mode. */
                         | IOCON_PIO_I2CSLEW(PIO025_I2CSLEW_I2C_MODE)
    ...
    IOCON->PIO[0][26] = ((IOCON->PIO[0][26] &
                         ...
                         /* Selects pin function.
                          * : PORT026 (pin 4) is configured as FC4_CTS_SDA_SSEL0. */
                         | IOCON_PIO_FUNC(PIO026_FUNC_ALT1)

                         /* Controls slew rate of I2C pad.
                          * : I2C mode. */
                         | IOCON_PIO_I2CSLEW(PIO026_I2CSLEW_I2C_MODE)
...
- options: {prefix: BOARD_, coreID: cm4, enableClock: 'true'}
- pin_list:
  - {pin_num: '58', peripheral: FLEXCOMM5, signal: TXD_SCL_MISO, pin_signal: PIO0_18/FC5_TXD_SCL_MISO/SCT0_OUT0/CTIMER0_MAT0, identifier: SPI_FLASH_MISO}
  - {pin_num: '59', peripheral: FLEXCOMM5, signal: SCK, pin_signal: PIO0_19/FC5_SCK/SCT0_OUT1/CTIMER0_MAT1, identifier: SPI_FLASH_SCK}
...
void BOARD_InitSPI_FLASHPins(void)
{
    ...
    IOCON->PIO[1][2] = ((IOCON->PIO[1][2] &
                        ...
                        /* Selects pin function.
                         * : PORT12 (pin 16) is configured as FC5_SSEL3. */
                        | IOCON_PIO_FUNC(PIO12_FUNC_ALT4)
...
- pin_list:
  ...
  - {pin_num: '46', peripheral: FLEXCOMM3, signal: SCK, pin_signal: PIO0_11/FC3_SCK/FC6_RXD_SDA_MOSI_DATA/CTIMER2_MAT1, direction: OUTPUT}
  - {pin_num: '47', peripheral: FLEXCOMM3, signal: RXD_SDA_MOSI, pin_signal: PIO0_12/FC3_RXD_SDA_MOSI/FC6_TXD_SCL_MISO_WS/CTIMER2_MAT3, direction: OUTPUT}
  - {pin_num: '48', peripheral: FLEXCOMM3, signal: TXD_SCL_MISO, pin_signal: PIO0_13/FC3_TXD_SCL_MISO/SCT0_OUT4/CTIMER2_MAT0, direction: INPUT}
  - {pin_num: '49', peripheral: FLEXCOMM3, signal: CTS_SDA_SSEL0, pin_signal: PIO0_14/FC3_CTS_SDA_SSEL0/SCT0_OUT5/CTIMER2_MAT1/FC1_SCK, direction: OUTPUT}
  ...
  - {pin_num: '2', peripheral: FLEXCOMM1, signal: CTS_SDA_SSEL0, pin_signal: PIO0_24/FC1_CTS_SDA_SSEL0/CTIMER0_CAP1/CTIMER0_MAT0, identifier: BRIDGE_SDA, i2c_slew: i2c}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPMod_SPI_I2C_BRIDGEPins(void)
{
    ...
    IOCON->PIO[0][11] = ((IOCON->PIO[0][11] &
                         ...
                         /* Selects pin function.
                          * : PORT011 (pin 46) is configured as FC3_SCK. */
    ...
    IOCON->PIO[0][12] = ((IOCON->PIO[0][12] &
                         ...
                         /* Selects pin function.
                          * : PORT012 (pin 47) is configured as FC3_RXD_SDA_MOSI. */
    ...
    IOCON->PIO[0][13] = ((IOCON->PIO[0][13] &
                         ...
                         /* Selects pin function.
                          * : PORT013 (pin 48) is configured as FC3_TXD_SCL_MISO. */
    ...
    IOCON->PIO[0][14] = ((IOCON->PIO[0][14] &
                         ...
                         /* Selects pin function.
                          * : PORT014 (pin 49) is configured as FC3_CTS_SDA_SSEL0. */
